...
public class LinkStatsModel
{
    ...
    public List<DailyStatModel> DailyViews { get; set; } = [];

    [JsonPropertyName("bySource")]
    public List<TrafficSourceModel> Sources { get; set; } = [];
}
...
public class DailyStatModel
{
    ...
    [JsonIgnore]
    public DateTime Date => DateTime.TryParse(DateStr, out var d) ? d : DateTime.UtcNow;
...
public class TrafficSourceModel
{
    ...
    [JsonIgnore]
    public float Percentage { get; set; } // We will calculate this manually
}
